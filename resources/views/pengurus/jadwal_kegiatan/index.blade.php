    ...
    <div class="flex h-screen xl:container overflow-auto">
        ...
        <div class="w-screen min-h-fit ml-10 mt-2 text-white">
            <div class="flex justify-between w-19 mr-20 ml-12 mt-8">
                <span class="self-center text-2xl font-medium text-black uppercase">Jadwal Kegiatan</span>
                <a href="/jadwal_kegiatan/create" class="btn btn-primary">Create New</a>
            </div>
                    ...
                    <tbody>
                        @foreach ($jadwals as $jadwal)
                            <tr class="hover hover:cursor-pointer">
                                ...
                                <td>{{ $jadwal->tempat }}</td>
                                <td>{{ $jadwal->acara }}</td>
                                <td class="p-0"><a href="/jadwal_kegiatan/{{ $jadwal->id }}/edit"
                                        class="btn btn-primary btn-xs text-white"> Edit
                                    </a></td>
                                <td class="p-0">
