          ...
          <div class="flex flex-row flex-wrap justify-center mt-2">
              ...
              <div class="flex flex-col basis-4/6 mt-2">
                  ...
                  <label class="w-full p-2">
                      <input type="date" name="tanggal" value="{{ old('tanggal', $event->tanggal) }}"
                          placeholder="Tanggal" class="input input-bordered w-full @error('tanggal') border-2 border-red-500 @enderror">
              ...
              <div class="flex flex-row basis-4/6 mt-2">
                  <div class="flex flex-col basis-1/2 mt-2">
                      <label class="label">
                          <span
                              class="label-text uppercase tracking-wide text-gray-700 text-sm font-bold ml-1">Waktu</span>
                      </label>
                      <label class="w-full p-2">
                  ...
                  <div class="flex flex-col basis-1/2 mt-2">
                      ...
                      <label class="w-full p-2">
                          <input type="text" name="ketua_event" value="{{ old('ketua_event', $event->ketua_event) }}"
                              placeholder="Ketua Event"
                              class="input input-bordered w-full @error('ketua_event') border-2 border-red-500 @enderror ">
                  ...
                  <label class="w-full p-2" id="repeater-head">
                      <tr>
                          @foreach ($roles as $role)
                              <td>
                                  <input type="text" name="roles_panitia[]" value="{{ $role }}"
                                      placeholder="Jabatan Panitia"
                                      class="input input-bordered w-full mb-2 @error('roles_panitia') border-2 border-red-500 @enderror">
                              </td>
                          @endforeach
                      </tr>
                      @error('roles_panitia')
